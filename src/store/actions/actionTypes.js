...
// Trip
export const LOAD_TRIP_DATA_START = "LOAD_TRIP_DATA_START";
export const LOAD_TRIP_DATA_SUCCESS = "LOAD_TRIP_DATA_SUCCESS";
export const LOAD_TRIP_DATA_FAIL = "LOAD_TRIP_DATA_FAIL";